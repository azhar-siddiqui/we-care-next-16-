        ...
        <div className="grid min-h-[600px] grid-cols-1 items-center gap-8 px-4 py-16 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
              Streamline Your <span className="text-primary">Laboratory</span>{" "}
              Operations
            </h1>
            <p className="max-w-md text-lg">
              All-in-one solution for patient report generation, inventory
              management, and seamless SAAS integration.
            </p>
            ...
            <div className="flex flex-col items-center gap-4 pt-4 sm:flex-row">
              ...
              <p className="text-foreground text-sm">
                Trusted by{" "}
                <span className="text-foreground font-medium">2,000+</span> labs
                worldwide
              </p>
            </div>
          </div>
