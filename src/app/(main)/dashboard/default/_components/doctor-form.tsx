import { addDoctorApiAction } from "@/actions/doctor/doctor";
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-625">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the doctor&apos;s information below. Click save when
            you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder={
                        form.formState.errors.email?.message ?? "Enter Email"
                      }
                      {...field}
                      value={field.value ?? ""}
                      autoComplete="off"
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  <FormControl>
                    <Input
                      placeholder={
                        form.formState.errors.degree?.message ?? "Enter Degree"
                      }
                      {...field}
                      autoComplete="off"
                      className={cn(
